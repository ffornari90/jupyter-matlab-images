...
FROM harbor.cloud.infn.it/jupyter-matlab/jaas_user_containers:rgw AS base_jupyter_image

# Base Jupyter image with LICENSE_SERVER
FROM harbor.cloud.infn.it/jupyter-matlab/jaas_user_containers:rgw AS base_jupyter_image_with_lm
ARG LICENSE_SERVER
